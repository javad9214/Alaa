...
class ParentProduct_Component (context: Context , attributeSet: AttributeSet) : CardView(context , attributeSet) {
    ...
    init {
        ...
        val title: MyTextView = findViewById(R.id.title_parent)
        val realPrice: MyTextView = findViewById(R.id.realPrice_parent)
        val salePrice: MyTextView = findViewById(R.id.finalPrice_parent)
        val discount: MyTextView = findViewById(R.id.discount_parent)
