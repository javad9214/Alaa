...
class SampleVideoAdapter (private val sampleList : ArrayList<SampleVideoModel>): RecyclerView.Adapter<SampleVideoAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        val title : com.example.alaa.customViews.MyTextView = itemView.findViewById(R.id.title_sample_video)
        val teacherName : com.example.alaa.customViews.MyTextView = itemView.findViewById(R.id.tx_teacherName)
