...
class MyChip (context: Context, attrs: AttributeSet) : Chip(context , attrs) {


    init {

        val typed : TypedArray = context.obtainStyledAttributes(attrs , R.styleable.MyChip , 0 , 0)

        val fontOrdinal : Int = typed.getInt(R.styleable.MyChip_MyChipFont , 0)
